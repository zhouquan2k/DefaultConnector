...
public class EventHeldPDU extends EventPDU {
	...
	@Override
	public EventHeldPDU sendEventToClient(CallInfoManager callInfoManager) {

		Util.trace(this, "HeldEvent : [callID=" + this.callID + ",eventID="
				+ this.getEventID() + "]");
		if (callInfoManager != null) {
			...
			Util.trace(this, "Held event callInfoManager is null. ");
		}

		Util.trace(this,
				"Send heldEvent [callID=" + this.callID + ",ucid=" + this.ucid
