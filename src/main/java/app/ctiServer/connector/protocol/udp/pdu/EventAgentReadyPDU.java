...
public class EventAgentReadyPDU extends EventPDU {
	...
	public EventAgentStateChangedV2PDU sendEventToClient(CallInfoManager callInfoManager) {
		...
		agentStateChangedEvent.setEventName("event_AgentStateChangedV2_Ready");
		...
		agentStateChangedEvent.setAgentState("3");
